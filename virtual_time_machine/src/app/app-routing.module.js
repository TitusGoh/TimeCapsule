...
var routes = [
    ...
    { path: 'create', component: createTemplate_component_1.createTemplateComponent },
    { path: 'view', component: in_progress_completed_component_1.InProgresCompletedComponent }
];
